...
const styles = StyleSheet.create({
  ...
  ringText: { fontSize: 11.5, fontWeight: '700', color: TXT, fontFamily: FONTS.latoBold },
  ...
  footerNudge: { flex: 1, fontSize: 13.5, color: TXTSUB, fontFamily: FONTS.lato, lineHeight: 18.5 },
  moreBtn: {
