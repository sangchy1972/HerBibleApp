...
// "Did you know?" Bible-fact card content. Each fact has a localized
// narrative text + a Bible reference (kept English-form so the deep-link
// to bibleReader resolves consistently regardless of UI language — the
// reader screen takes care of translating the book label visually).
export interface FunFact { text: string; relatedRefs: string[] }

const FUN_FACTS_EN: FunFact[] = [
  { text: 'After meeting Jesus by a well, the Samaritan woman became an evangelist to her people. (John 4:7-29)', relatedRefs: ['Romans 16:22'] },
  { text: 'The shortest verse in the English Bible is "Jesus wept." — just two words.', relatedRefs: ['John 11:35'] },
  { text: 'Esther is one of only two books in the Bible named after a woman, alongside Ruth.', relatedRefs: ['Esther 4:14'] },
  { text: 'Mary Magdalene was the first person Jesus appeared to after the resurrection.', relatedRefs: ['John 20:11-18'] },
  { text: 'Deborah was a prophet, judge, and warrior who led Israel to victory.', relatedRefs: ['Judges 4:4-9'] },
];

const FUN_FACTS_ZH_HANS: FunFact[] = [
  { text: '撒玛利亚妇人在井边遇见耶稣后，成了向她族人传福音的传道者。（约翰福音 4:7-29）', relatedRefs: ['Romans 16:22'] },
  { text: '英文圣经中最短的一节经文是「耶稣哭了。」——只有两个英文字。', relatedRefs: ['John 11:35'] },
  { text: '以斯帖记是圣经中仅有两卷以女性命名的书之一，另一卷是路得记。', relatedRefs: ['Esther 4:14'] },
  { text: '抹大拉的马利亚是耶稣复活后向她显现的第一人。', relatedRefs: ['John 20:11-18'] },
  { text: '底波拉是一位先知、士师，也是战士，带领以色列得胜。', relatedRefs: ['Judges 4:4-9'] },
];

const FUN_FACTS_ZH_HANT: FunFact[] = [
  { text: '撒瑪利亞婦人在井邊遇見耶穌後，成了向她族人傳福音的傳道者。（約翰福音 4:7-29）', relatedRefs: ['Romans 16:22'] },
  { text: '英文聖經中最短的一節經文是「耶穌哭了。」——只有兩個英文字。', relatedRefs: ['John 11:35'] },
  { text: '以斯帖記是聖經中僅有兩卷以女性命名的書之一，另一卷是路得記。', relatedRefs: ['Esther 4:14'] },
  { text: '抹大拉的馬利亞是耶穌復活後向她顯現的第一人。', relatedRefs: ['John 20:11-18'] },
  { text: '底波拉是一位先知、士師，也是戰士，帶領以色列得勝。', relatedRefs: ['Judges 4:4-9'] },
];

const FUN_FACTS_DE: FunFact[] = [
  { text: 'Nachdem sie Jesus am Brunnen begegnet war, wurde die samaritische Frau zur Evangelistin für ihr Volk. (Johannes 4,7-29)', relatedRefs: ['Romans 16:22'] },
  { text: 'Der kürzeste Vers in der englischen Bibel ist „Jesus wept." — nur zwei Worte.', relatedRefs: ['John 11:35'] },
  { text: 'Esther ist eines der nur zwei Bücher der Bibel, die nach einer Frau benannt sind — neben Ruth.', relatedRefs: ['Esther 4:14'] },
  { text: 'Maria Magdalena war die erste Person, der Jesus nach der Auferstehung erschien.', relatedRefs: ['John 20:11-18'] },
  { text: 'Debora war Prophetin, Richterin und Kriegerin und führte Israel zum Sieg.', relatedRefs: ['Judges 4:4-9'] },
];

const FUN_FACTS_FR: FunFact[] = [
  { text: 'Après avoir rencontré Jésus près d\'un puits, la Samaritaine est devenue évangéliste auprès des siens. (Jean 4:7-29)', relatedRefs: ['Romans 16:22'] },
  { text: 'Le verset le plus court de la Bible anglaise est « Jésus pleura. » — seulement deux mots.', relatedRefs: ['John 11:35'] },
  { text: 'Esther est l\'un des deux seuls livres de la Bible portant le nom d\'une femme, avec Ruth.', relatedRefs: ['Esther 4:14'] },
  { text: 'Marie de Magdala est la première personne à qui Jésus est apparu après la résurrection.', relatedRefs: ['John 20:11-18'] },
  { text: 'Déborah était prophétesse, juge et guerrière, et a conduit Israël à la victoire.', relatedRefs: ['Judges 4:4-9'] },
];

const FUN_FACTS_ES: FunFact[] = [
  { text: 'Tras encontrarse con Jesús junto a un pozo, la mujer samaritana se convirtió en evangelista para su pueblo. (Juan 4:7-29)', relatedRefs: ['Romans 16:22'] },
  { text: 'El versículo más corto de la Biblia en inglés es «Jesus wept.» — solo dos palabras.', relatedRefs: ['John 11:35'] },
  { text: 'Ester es uno de los dos únicos libros de la Biblia con nombre de mujer, junto con Rut.', relatedRefs: ['Esther 4:14'] },
  { text: 'María Magdalena fue la primera persona a la que Jesús se apareció tras la resurrección.', relatedRefs: ['John 20:11-18'] },
  { text: 'Débora fue profetisa, jueza y guerrera, y guio a Israel a la victoria.', relatedRefs: ['Judges 4:4-9'] },
];

const FUN_FACTS_PT: FunFact[] = [
  { text: 'Depois de encontrar Jesus junto a um poço, a samaritana tornou-se evangelista do seu povo. (João 4:7-29)', relatedRefs: ['Romans 16:22'] },
  { text: 'O versículo mais curto da Bíblia em inglês é "Jesus wept." — apenas duas palavras.', relatedRefs: ['John 11:35'] },
  { text: 'Ester é um dos dois únicos livros da Bíblia com nome de mulher, junto com Rute.', relatedRefs: ['Esther 4:14'] },
  { text: 'Maria Madalena foi a primeira pessoa a quem Jesus apareceu após a ressurreição.', relatedRefs: ['John 20:11-18'] },
  { text: 'Débora foi profetisa, juíza e guerreira, e conduziu Israel à vitória.', relatedRefs: ['Judges 4:4-9'] },
];

const FUN_FACTS_BY_LANG: Record<UILanguageCode, FunFact[]> = {
  en: FUN_FACTS_EN,
  'zh-Hans': FUN_FACTS_ZH_HANS,
  'zh-Hant': FUN_FACTS_ZH_HANT,
  de: FUN_FACTS_DE,
  fr: FUN_FACTS_FR,
  es: FUN_FACTS_ES,
  pt: FUN_FACTS_PT,
...
export function getFunFacts(lang: UILanguageCode): FunFact[] {
  return FUN_FACTS_BY_LANG[lang] || FUN_FACTS_EN;
}

// Kept for any legacy callers without language context. Prefer
// `getFunFacts(lang)`.
export const FUN_FACTS = FUN_FACTS_EN;
