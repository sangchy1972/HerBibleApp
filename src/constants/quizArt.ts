...
export const QUIZ_ART: readonly QuizArtwork[] = [
  ...
  // APPENDED, never inserted. `completedPaintings` is a COUNT, so index 2
  // means "the third entry in this array, whatever it is today" — putting
  // Genesis 3 at the front to fix the chronology would have re-pointed every
  // existing user's finished puzzles at different pictures. The list is
  // therefore chronological WITHIN each batch, not across the whole array,
  // and that is permanent. A user who reaches 25 walks the Bible again.
  {
    id: '043', aspect: 1.476, ref: 'Genesis 3',
    artist: 'Jacopo Tintoretto', year: '1550',
    artistCjk: { 'zh-Hans': '雅各布·丁托列托', 'zh-Hant': '雅各布·丁托列托' },
    title: {
      en: 'The Temptation of Adam',
      'zh-Hans': '亚当受诱惑',
      'zh-Hant': '亞當受誘惑',
      'de': 'Die Versuchung Adams',
      'fr': 'La Tentation d\'Adam',
      'es': 'La tentación de Adán',
      'pt': 'A Tentação de Adão',
    },
    desc: {
      en: 'Genesis 3. Eve leans out from behind the tree, holding out the fruit; Adam reaches for it with his body still turned away. Behind them Tintoretto painted the same two already being driven from the garden.',
      'zh-Hans': '创世记 3。夏娃自树后倾身，把果子递过来；亚当伸手去接，身子却仍朝后侧着。丁托列托在远处又画了这两人一次——已被逐出园子。',
      'zh-Hant': '創世記 3。夏娃自樹後傾身，把果子遞過來；亞當伸手去接，身子卻仍朝後側著。丁托列托在遠處又畫了這兩人一次——已被逐出園子。',
      'de': '1. Mose 3. Eva beugt sich hinter dem Baum hervor und reicht die Frucht; Adam greift danach, den Körper noch abgewandt. Im Hintergrund malte Tintoretto dieselben beiden ein zweites Mal — schon aus dem Garten vertrieben.',
      'fr': 'Genèse 3. Ève se penche de derrière l\'arbre et tend le fruit ; Adam avance la main, le corps encore détourné. Au fond, Tintoret a peint les deux mêmes une seconde fois, déjà chassés du jardin.',
      'es': 'Génesis 3. Eva se inclina desde detrás del árbol y ofrece el fruto; Adán alarga la mano con el cuerpo aún vuelto. Al fondo, Tintoretto pintó a esos mismos dos otra vez, ya expulsados del jardín.',
      'pt': 'Gênesis 3. Eva se inclina por trás da árvore e estende o fruto; Adão estica a mão com o corpo ainda voltado para o lado. Ao fundo, Tintoretto pintou os dois outra vez, já expulsos do jardim.',
    },
  },
  {
    id: '011', aspect: 1.322, ref: 'Genesis 28',
    artist: 'Jusepe de Ribera', year: '1639',
    artistCjk: { 'zh-Hans': '胡塞佩·德·里贝拉', 'zh-Hant': '胡塞佩·德·里貝拉' },
    title: {
      en: 'Jacob\'s Dream',
      'zh-Hans': '雅各的梦',
      'zh-Hant': '雅各的夢',
      'de': 'Jakobs Traum',
      'fr': 'Le Songe de Jacob',
      'es': 'El sueño de Jacob',
      'pt': 'O Sonho de Jacó',
    },
    desc: {
      en: 'Genesis 28. Jacob sleeps in the open with a stone for a pillow. Ribera gives him no ladder at all, only a shaft of daylight beside the tree, with angels so faint you must look twice.',
      'zh-Hans': '创世记 28。雅各枕石露天而卧。里贝拉根本没有画梯子，只在树旁留下一道天光，其中的天使淡得要看第二眼才认得出。',
      'zh-Hant': '創世記 28。雅各枕石露天而臥。里貝拉根本沒有畫梯子，只在樹旁留下一道天光，其中的天使淡得要看第二眼才認得出。',
      'de': '1. Mose 28. Jakob schläft im Freien, einen Stein als Kopfkissen. Ribera malt gar keine Leiter, nur eine Bahn Tageslicht neben dem Baum, mit Engeln so blass, dass man zweimal hinsehen muss.',
      'fr': 'Genèse 28. Jacob dort à ciel ouvert, une pierre sous la tête. Ribera ne peint aucune échelle : rien qu\'une traînée de lumière près de l\'arbre, avec des anges si pâles qu\'il faut regarder deux fois.',
      'es': 'Génesis 28. Jacob duerme al raso con una piedra por almohada. Ribera no pinta escalera alguna: solo un haz de luz junto al árbol, con ángeles tan tenues que hay que mirar dos veces.',
      'pt': 'Gênesis 28. Jacó dorme ao relento com uma pedra por travesseiro. Ribera não pinta escada nenhuma: apenas um facho de luz junto à árvore, com anjos tão tênues que é preciso olhar duas vezes.',
    },
  },
  {
    id: '032', aspect: 1.307, ref: 'Genesis 37',
    artist: 'Diego Velázquez', year: '1630',
    artistCjk: { 'zh-Hans': '迭戈·委拉斯开兹', 'zh-Hant': '迭戈·維拉斯奎茲' },
    title: {
      en: 'Joseph\'s Tunic',
      'zh-Hans': '约瑟的彩衣',
      'zh-Hant': '約瑟的彩衣',
      'de': 'Josephs blutiger Rock',
      'fr': 'La Tunique de Joseph',
      'es': 'La túnica de José',
      'pt': 'A Túnica de José',
    },
    desc: {
      en: 'Genesis 37. The brothers hold out the bloodied coat, and Jacob rises from his seat with both hands lifted. In the corner Velázquez put a small dog, barking at the men who are lying.',
      'zh-Hans': '创世记 37。众子把染血的衣袍递上，雅各从座上直起身来，双手举起。委拉斯开兹在角落画了一只小狗，对着说谎的人狂吠。',
      'zh-Hant': '創世記 37。眾子把染血的衣袍遞上，雅各從座上直起身來，雙手舉起。維拉斯奎茲在角落畫了一隻小狗，對著說謊的人狂吠。',
      'de': '1. Mose 37. Die Brüder halten den blutigen Rock hin, und Jakob fährt von seinem Sitz auf, beide Hände erhoben. In die Ecke setzte Velázquez einen kleinen Hund, der die Lügner anbellt.',
      'fr': 'Genèse 37. Les frères tendent la tunique ensanglantée, et Jacob se dresse de son siège, les deux mains levées. Dans l\'angle, Vélasquez a mis un petit chien qui aboie contre les menteurs.',
      'es': 'Génesis 37. Los hermanos tienden la túnica ensangrentada, y Jacob se alza de su asiento con las dos manos en alto. En el ángulo, Velázquez puso un perrillo que ladra a los que mienten.',
      'pt': 'Gênesis 37. Os irmãos estendem a túnica ensanguentada, e Jacó se ergue do assento com as duas mãos levantadas. No canto, Velázquez pôs um cãozinho ladrando para os que mentem.',
    },
  },
  {
    id: '022', aspect: 1.18, ref: 'Genesis 48',
    artist: 'Rembrandt', year: '1656',
    artistCjk: { 'zh-Hans': '伦勃朗', 'zh-Hant': '林布蘭' },
    title: {
      en: 'Jacob Blessing the Sons of Joseph',
      'zh-Hans': '雅各为约瑟的儿子祝福',
      'zh-Hant': '雅各為約瑟的兒子祝福',
      'de': 'Jakob segnet die Söhne Josephs',
      'fr': 'Jacob bénissant les fils de Joseph',
      'es': 'Jacob bendiciendo a los hijos de José',
      'pt': 'Jacó abençoando os filhos de José',
    },
    desc: {
      en: 'Genesis 48. Dying Jacob lays his right hand on the younger boy, and Joseph reaches gently beneath his father\'s arm to move it. Rembrandt added Joseph\'s Egyptian wife at the bedside; scripture never puts her there.',
      'zh-Hans': '创世记 48。将死的雅各把右手按在幼孙头上，约瑟从父亲臂下轻轻托住，想把那只手挪开。伦勃朗还在床边添了约瑟的埃及妻子——经文里并没有她。',
      'zh-Hant': '創世記 48。將死的雅各把右手按在幼孫頭上，約瑟從父親臂下輕輕托住，想把那隻手挪開。林布蘭還在床邊添了約瑟的埃及妻子——經文裡並沒有她。',
      'de': '1. Mose 48. Der sterbende Jakob legt die rechte Hand auf den jüngeren Knaben, und Joseph greift sanft unter den Arm des Vaters, um sie zu lenken. Rembrandt stellte Josephs ägyptische Frau ans Bett — die Schrift kennt sie dort nicht.',
      'fr': 'Genèse 48. Jacob mourant pose la main droite sur le cadet, et Joseph glisse doucement la sienne sous le bras de son père pour la déplacer. Rembrandt a ajouté au chevet l\'épouse égyptienne de Joseph, absente du texte.',
      'es': 'Génesis 48. Jacob moribundo pone la mano derecha sobre el nieto menor, y José desliza la suya bajo el brazo de su padre para apartarla. Rembrandt añadió junto al lecho a la esposa egipcia de José, que el texto no menciona.',
      'pt': 'Gênesis 48. Jacó moribundo põe a mão direita sobre o neto mais novo, e José desliza a sua sob o braço do pai para desviá-la. Rembrandt acrescentou à cabeceira a esposa egípcia de José, que o texto não menciona.',
    },
  },
  {
    id: '048', aspect: 1.316, ref: '1 Kings 10',
    artist: 'Claude Lorrain', year: '1648',
    artistCjk: { 'zh-Hans': '克洛德·洛兰', 'zh-Hant': '克勞德·洛蘭' },
    title: {
      en: 'The Embarkation of the Queen of Sheba',
      'zh-Hans': '示巴女王登船',
      'zh-Hant': '示巴女王登船',
      'de': 'Die Einschiffung der Königin von Saba',
      'fr': 'L\'Embarquement de la reine de Saba',
      'es': 'El embarque de la reina de Saba',
      'pt': 'O Embarque da Rainha de Sabá',
    },
    desc: {
      en: '1 Kings 10. The queen sets out by sea to put her hard questions to Solomon. Claude paints her small on the steps and gives the canvas to the dawn sun, a road of gold across the water.',
      'zh-Hans': '列王纪上 10。女王渡海而去，要用难解的话试问所罗门。洛兰把她画得很小，只落在台阶上；整幅画让给了初升的太阳，海面铺开一条金路。',
      'zh-Hant': '列王紀上 10。女王渡海而去，要用難解的話試問所羅門。洛蘭把她畫得很小，只落在台階上；整幅畫讓給了初升的太陽，海面鋪開一條金路。',
      'de': '1. Könige 10. Die Königin sticht in See, um Salomo mit schweren Fragen zu prüfen. Claude Lorrain malt sie klein auf der Treppe und überlässt das Bild der Morgensonne, die eine goldene Straße übers Wasser legt.',
      'fr': '1 Rois 10. La reine s\'embarque pour aller éprouver Salomon par des énigmes. Claude la peint minuscule sur les marches et laisse la toile au soleil levant, qui trace une route d\'or sur l\'eau.',
      'es': '1 Reyes 10. La reina se embarca para poner a prueba a Salomón con preguntas difíciles. Claude Lorrain la pinta diminuta en la escalinata y entrega el lienzo al sol naciente, que tiende un camino de oro sobre el agua.',
      'pt': '1 Reis 10. A rainha embarca para pôr Salomão à prova com perguntas difíceis. Claude Lorrain a pinta minúscula na escadaria e entrega a tela ao sol nascente, que estende um caminho de ouro sobre a água.',
    },
  },
  {
    id: '027', aspect: 1.311, ref: 'Esther 7',
    artist: 'Rembrandt', year: '1660',
    artistCjk: { 'zh-Hans': '伦勃朗', 'zh-Hant': '林布蘭' },
    title: {
      en: 'Ahasuerus and Haman at the Feast of Esther',
      'zh-Hans': '以斯帖筵席上的亚哈随鲁与哈曼',
      'zh-Hant': '以斯帖筵席上的亞哈隨魯與哈曼',
      'de': 'Ahasver und Haman beim Gastmahl der Esther',
      'fr': 'Assuérus et Aman au festin d\'Esther',
      'es': 'Asuero y Amán en el banquete de Ester',
      'pt': 'Assuero e Hamã no banquete de Ester',
    },
    desc: {
      en: 'Esther 7. At her own table Esther names the man who plotted against her people. Rembrandt keeps only three figures: the king holding in his anger, Esther beside him, and Haman at the edge, head down.',
      'zh-Hans': '以斯帖记 7。筵席之上，以斯帖当面指出那谋害本族的人。伦勃朗只留下三个人：强忍怒气的王、王身旁的以斯帖，以及被挤到画边、垂着头的哈曼。',
      'zh-Hant': '以斯帖記 7。筵席之上，以斯帖當面指出那謀害本族的人。林布蘭只留下三個人：強忍怒氣的王、王身旁的以斯帖，以及被擠到畫邊、垂著頭的哈曼。',
      'de': 'Ester 7. An ihrem eigenen Tisch nennt Ester den Mann, der ihr Volk vernichten wollte. Rembrandt lässt nur drei Gestalten: den König, der den Zorn zurückhält, Ester an seiner Seite und Haman am Rand, den Kopf gesenkt.',
      'fr': 'Esther 7. À sa propre table, Esther nomme celui qui a comploté contre son peuple. Rembrandt ne garde que trois figures : le roi contenant sa colère, Esther à ses côtés, et Aman rejeté au bord, tête basse.',
      'es': 'Ester 7. En su propia mesa, Ester nombra al hombre que tramó la ruina de su pueblo. Rembrandt deja solo tres figuras: el rey conteniendo la ira, Ester a su lado y Amán al borde del cuadro, cabizbajo.',
      'pt': 'Ester 7. À sua própria mesa, Ester nomeia o homem que tramou contra o seu povo. Rembrandt deixa apenas três figuras: o rei contendo a ira, Ester ao seu lado e Hamã na borda do quadro, de cabeça baixa.',
    },
  },
  {
    id: '026', aspect: 1.247, ref: 'Luke 2:41-52',
    artist: 'Albrecht Dürer', year: '1506',
    artistCjk: { 'zh-Hans': '阿尔布雷希特·丢勒', 'zh-Hant': '阿爾布雷希特·杜勒' },
    title: {
      en: 'Christ Among the Doctors',
      'zh-Hans': '基督在博士中间',
      'zh-Hant': '基督在博士中間',
      'de': 'Christus unter den Schriftgelehrten',
      'fr': 'Le Christ parmi les docteurs',
      'es': 'Jesús entre los doctores',
      'pt': 'Cristo entre os doutores',
    },
    desc: {
      en: 'Luke 2. His parents find the twelve-year-old in the temple, listening and asking questions. Dürer crowds the heads up against the surface and sets the boy\'s smooth hands, counting off an argument, against an old scholar\'s knotted ones.',
      'zh-Hans': '路加福音 2。父母在圣殿里寻见十二岁的耶稣，他正听着、问着。丢勒把一颗颗头挤到画面最前，让少年光洁的手掰着指头数说道理，与老学者枯瘦嶙峋的手相对。',
      'zh-Hant': '路加福音 2。父母在聖殿裡尋見十二歲的耶穌，他正聽著、問著。杜勒把一顆顆頭擠到畫面最前，讓少年光潔的手扳著指頭數說道理，與老學者枯瘦嶙峋的手相對。',
      'de': 'Lukas 2. Die Eltern finden den Zwölfjährigen im Tempel, zuhörend und fragend. Dürer drängt die Köpfe dicht an die Bildfläche und stellt die glatten Hände des Knaben, die ein Argument abzählen, gegen die knotigen eines alten Gelehrten.',
      'fr': 'Luc 2. Ses parents retrouvent l\'enfant de douze ans au Temple, écoutant et interrogeant. Dürer serre les têtes contre la surface du panneau et oppose les mains lisses du garçon, qui compte un argument, aux mains noueuses d\'un vieux docteur.',
      'es': 'Lucas 2. Sus padres encuentran al niño de doce años en el Templo, escuchando y preguntando. Durero apiña las cabezas contra la superficie y enfrenta las manos lisas del muchacho, que cuenta un argumento, a las nudosas de un viejo doctor.',
      'pt': 'Lucas 2. Seus pais encontram o menino de doze anos no Templo, ouvindo e perguntando. Dürer comprime as cabeças contra a superfície e opõe as mãos lisas do menino, que conta um argumento nos dedos, às mãos nodosas de um velho doutor.',
    },
  },
  {
    id: '016', aspect: 1.435, ref: 'John 8:1-11',
    artist: 'Pieter Bruegel the Elder', year: '1565',
    artistCjk: { 'zh-Hans': '老彼得·勃鲁盖尔', 'zh-Hant': '老彼得·布勒哲爾' },
    title: {
      en: 'Christ and the Woman Taken in Adultery',
      'zh-Hans': '基督与行淫时被拿的妇人',
      'zh-Hant': '基督與行淫時被拿的婦人',
      'de': 'Christus und die Ehebrecherin',
      'fr': 'Le Christ et la femme adultère',
      'es': 'Cristo y la mujer adúltera',
      'pt': 'Cristo e a mulher adúltera',
    },
    desc: {
      en: 'John 8. Asked what should be done with her, Christ stoops and writes in the dust. Bruegel painted the whole small panel in greys and put the words in Flemish: he who is without sin.',
      'zh-Hans': '约翰福音 8。众人问该怎样处置这妇人，基督俯身在地上写字。勃鲁盖尔把这块小木板整幅画成灰调，并用佛兰德语写下那句话：你们中间谁是没有罪的。',
      'zh-Hant': '約翰福音 8。眾人問該怎樣處置這婦人，基督俯身在地上寫字。布勒哲爾把這塊小木板整幅畫成灰調，並用法蘭德斯語寫下那句話：你們中間誰是沒有罪的。',
      'de': 'Johannes 8. Auf die Frage, was mit ihr geschehen solle, bückt sich Christus und schreibt in den Staub. Bruegel malte die kleine Tafel ganz in Grautönen und setzte die Worte auf Flämisch: Wer ohne Sünde ist.',
      'fr': 'Jean 8. Quand on lui demande ce qu\'il faut faire d\'elle, le Christ se baisse et écrit dans la poussière. Bruegel a peint le petit panneau tout en gris et inscrit la phrase en flamand : que celui qui est sans péché…',
      'es': 'Juan 8. Cuando le preguntan qué hacer con ella, Cristo se inclina y escribe en el polvo. Brueghel pintó la pequeña tabla toda en grises y puso las palabras en flamenco: el que esté sin pecado.',
