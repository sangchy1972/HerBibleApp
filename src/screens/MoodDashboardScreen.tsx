...
const styles = StyleSheet.create({
  ...
  miniCard: { borderRadius: 14, padding: 8, backgroundColor: 'rgba(30,27,46,0.03)' },
  miniCardOn: { backgroundColor: '#FFFFFF', shadowColor: '#000', shadowOffset: { width: 0, height: 3 }, shadowOpacity: 0.12, shadowRadius: 8, elevation: 4 },
