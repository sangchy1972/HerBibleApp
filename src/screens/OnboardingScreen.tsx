  ...
  return (
    <View style={styles.root}>
      ...
      <Animated.View
        ...
        style={[styles.bottom, { paddingBottom: insets.bottom + 28 }]}
      >
        {step === 'cover' ? (
          <>
            <Text style={styles.title}>Connect with God</Text>
            <Text style={styles.subtitle}>
              To enjoy a daily verse and gentle reminders to pray,{'\n'}turn on notifications.
            </Text>
            <TouchableOpacity
...
function PermissionSheet({ onAllow, onSkip }: { onAllow: () => void; onSkip: () => void }) {
  return (
    ...
    >
      ...
      <Text style={styles.sheetTitle}>Daily verses & prayer reminders</Text>
      <Text style={styles.sheetDesc}>
        We'll send a short morning verse and an evening prayer cue. You can change or turn this off
        anytime in Settings — we never share your information.
      </Text>
