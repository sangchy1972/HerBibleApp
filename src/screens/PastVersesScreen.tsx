...
function dateLabel(offset: number, d: Date): string {
...
export default function PastVersesScreen({ navigation }: RootStackScreenProps<'PastVerses'>) {
  ...
  const rows = useMemo<Row[]>(() => {
    ...
    return out;
  }, [getVerse, todayDay, translation.code]);
  ...
  return (
    <View style={[styles.root, { paddingTop: insets.top + 8 }]}>
      <View style={styles.header}>
        ...
        <Text style={styles.title}>Verses of the Day</Text>
