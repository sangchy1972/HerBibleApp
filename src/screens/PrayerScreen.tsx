...
const styles = StyleSheet.create({
  ...
  dateText: {
    ...
    color: TXTSUB,
    letterSpacing: 1.8,
    marginBottom: -2,                                                           // 1 → -2 (-3 px per user) — closes the gap to the greeting below
  ...
  // Inner pill +10 % height per user — paddingVertical 7 → 8.5 (1.5 px both
  // sides) widens the button vertically; the indicator (top/bottom/left: 2)
  // tracks it because it's absolute-positioned inside the same container.
  // The outer white frame grows by the same 3 px so the pink/lav chip stays
  ...
  startBtn: {
    marginTop: 17.8,                    // 16 → 12.8 → 17.8 (+5 px per user — card ↔ Start CTA gap)
    marginBottom: 10,
